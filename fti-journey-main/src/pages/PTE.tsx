...
import { Check, Monitor, Cpu, User, Cloud, ArrowRight, Star, BookOpen, Clock, Award, Target, TrendingUp, Headphones, Mic, PenTool, Eye, ChevronRight, BarChart3, Globe, Zap } from 'lucide-react';
      ...
      <div className="page-transition">
        ...
        <section className="bg-gradient-to-br from-orange-500 via-amber-500 to-orange-600 py-24 md:py-36 relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 relative z-10">
            ...
            >
              <span className="inline-block bg-white/20 rounded-full px-5 py-1.5 text-sm font-bold mb-6 border border-white/30 tracking-widest uppercase">
