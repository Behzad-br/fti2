...
const features = [
  ...
  },
  {
    ...
    text: 'Comprehensive sessions to prepare you for life in a new country.',
  ...
  },
  {
    ...
    text: 'Assistance with accommodation and settling in after you arrive.',
...
const stats = [
  ...
  { icon: Award, value: 98, suffix: '%', label: 'Visa Success Rate' },
  { icon: Clock, value: 12, suffix: '+', label: 'Years Experience' },
  { icon: BookOpen, value: 200, suffix: '+', label: 'Test Prep Batches' },
];
  ...
  return (
    <section className="py-32 relative overflow-hidden bg-[#fafafa]">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          <span className="inline-block py-1.5 px-4 rounded-full bg-primary/10 text-primary font-bold text-xs uppercase tracking-[0.2em] mb-6 shadow-[0_0_20px_rgba(249,115,22,0.15)]">
            Why Choose Us
          </span>
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-black text-slate-800 mb-4 tracking-tight">
            Your Premium Path to <br /> Global Success
          </h2>
          <p className="text-muted-foreground max-w-2xl mx-auto text-lg md:text-xl leading-relaxed">
            Experience a journey crafted for excellence. We blend expert guidance with personalized care to ensure your study abroad dreams become a reality.
          </p>
        </motion.div>
