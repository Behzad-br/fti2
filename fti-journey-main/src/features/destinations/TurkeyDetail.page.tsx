      ...
      <div className="page-transition bg-[#FAFAFA] min-h-screen">
        ...
        <section ref={heroRef} className="relative h-[70vh] min-h-[600px] flex items-center justify-center overflow-hidden rounded-b-[3rem] shadow-2xl">
          <motion.div style={{ y, opacity }} className="absolute inset-0 w-full h-full">
            <img
              src="https://images.unsplash.com/photo-1524231757912-21f4fe3a7200?auto=format&fit=crop&w=1200"
              alt="Study in Turkey - Cappadocia"
          ...
          <div className="container relative z-10 mx-auto px-4 text-center mt-16">
            ...
            >
              Study in <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-400 to-orange-500">Turkey</span>
            </motion.h1>
            ...
            >
              Quality Education. Rich Heritage. Affordable Excellence.
            </motion.p>
          </div>
          ...
          >
            {[
              { icon: Building, label: 'Universities', value: '200+' },
              { icon: Globe, label: 'Intl. Students', value: 'Expanding' },
              ...
              <div className="lg:col-span-8 space-y-16">
                ...
                >
                  <motion.div variants={fadeUp} className="flex items-center gap-4 mb-6">
                    ...
                    <h2 className="text-3xl md:text-4xl font-black text-foreground tracking-tight">Discover Turkey</h2>
                  </motion.div>
                  
                  <motion.p variants={fadeUp} className="text-lg text-muted-foreground leading-relaxed mb-6">
                    Turkey has become one of the fastest-growing destinations for international students, offering high-quality education, internationally recognised qualifications, and affordable tuition fees. Positioned at the crossroads of Europe and Asia, Turkey provides a unique blend of modern education, rich cultural heritage, and strong global connectivity.
                  </motion.p>
                  <motion.p variants={fadeUp} className="text-lg text-muted-foreground leading-relaxed mb-10">
                    With over 200 universities, state-of-the-art campuses, and an expanding international student community, Turkey offers excellent academic opportunities alongside a vibrant and affordable lifestyle.
                  </motion.p>
                  ...
                  <motion.div variants={fadeUp} className="grid grid-cols-1 md:grid-cols-3 gap-4 h-[400px]">
                    <div className="md:col-span-2 h-full rounded-3xl overflow-hidden group relative shadow-lg">
                      <img src="https://images.unsplash.com/photo-1524231757912-21f4fe3a7200?auto=format&fit=crop&w=1200" alt="Istanbul" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" />
                      <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent flex items-end p-6">
                        <span className="text-white font-bold text-xl drop-shadow-md">Vibrant Istanbul</span>
                      </div>
                    </div>
                    <div className="grid grid-rows-2 gap-4 h-full">
                      ...
                      <div className="rounded-3xl overflow-hidden group relative shadow-lg bg-gradient-to-br from-primary to-orange-600 flex items-center justify-center p-6 text-center">
                        <div>
                          ...
                          <p className="text-white/80 text-sm font-medium">Student Satisfaction</p>
                        </div>
                      </div>
                    </div>
                  </motion.div>
                ...
                >
                  <motion.div variants={fadeUp} className="flex items-center gap-4 mb-8">
                    ...
                    <h2 className="text-3xl font-bold text-foreground">Why Study in Turkey?</h2>
                  </motion.div>
                  ...
                  <div className="grid sm:grid-cols-2 gap-4">
                    {[
                      ...
                      'Modern universities and research facilities',
                ...
                >
                  ...
                  <motion.div variants={fadeUp} className="flex items-center gap-4 mb-8 relative z-10">
                    ...
                    <div>
                      <h2 className="text-3xl font-bold text-foreground">Turkey Education System</h2>
                      <p className="text-muted-foreground mt-1 text-sm">Regulated by the Council of Higher Education (YÖK)</p>
                    </div>
                  </motion.div>
                  ...
                  <div className="grid md:grid-cols-2 gap-10 relative z-10">
                    <div>
                      ...
                      <div className="flex flex-wrap gap-2">
                        {['Foundation Programmes', 'Associate Degrees', 'Bachelor\'s Degrees', 'Master\'s Degrees', 'Doctoral (PhD) Programmes', 'Medical & Professional Degrees'].map((level, i) => (
                    ...
                    {[
                      {
                        ...
                        icon: Briefcase,
                        items: ['Business Administration', 'International Business', 'Accounting', 'Finance', 'Marketing', 'HR Management', 'International Trade', 'Logistics']
                      },
                      {
                        title: 'Information Technology',
                        icon: Lightbulb,
                        items: ['Computer Science', 'Artificial Intelligence', 'Cyber Security', 'Software Engineering', 'Data Science', 'Information Systems']
                      },
                      {
                        title: 'Engineering',
                        icon: Building,
                        items: ['Civil Engineering', 'Mechanical', 'Electrical & Electronic', 'Computer', 'Mechatronics', 'Chemical', 'Industrial']
                      },
                      {
                        title: 'Health Sciences',
                        icon: CheckCircle,
                        items: ['Medicine', 'Dentistry', 'Pharmacy', 'Nursing', 'Physiotherapy', 'Public Health', 'Biomedical']
                      },
                      {
                        title: 'Architecture & Design',
                        icon: Home,
                        items: ['Architecture', 'Interior Architecture', 'Urban Planning', 'Graphic Design', 'Industrial Design']
                      },
                      {
                        title: 'Hospitality & Tourism',
                        icon: MapPin,
                        items: ['Hospitality Management', 'Tourism Management', 'Hotel Management', 'Culinary Arts']
                      },
                      {
                        title: 'Aviation',
                        icon: Plane,
                        items: ['Aviation Management', 'Aeronautical Engineering', 'Aircraft Maintenance']
                      }
                    ].map((category, i) => (
                      <motion.div 
                        key={i}
                ...
                >
                    ...
                    <motion.div variants={fadeUp} className="group relative bg-white p-8 rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100 hover:shadow-xl transition-all duration-300">
                      ...
                      <ul className="space-y-4">
                        {[
                          ...
                          'Valid passport', 
                          'English language proficiency (for English-medium programmes)',
                      ...
                      <p className="text-xs text-muted-foreground mt-4 italic">*Some universities may require additional entrance examinations or interviews.</p>
                    </motion.div>
                  ...
                  <motion.div variants={fadeUp} className="bg-gradient-to-br from-primary/5 to-orange-500/5 rounded-[2rem] p-8 md:p-10 border border-primary/20 relative overflow-hidden">
                    ...
                    <p className="text-muted-foreground mb-6">
                      Accepted tests: IELTS Academic, TOEFL iBT, PTE Academic (selected institutions), University English Proficiency Examination, and Cambridge English Qualifications.
                    </p>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      {[
                        { level: 'Bachelor\'s Degree', score: '5.5–6.0 IELTS' },
                        { level: 'Master\'s Degree', score: '6.0–6.5 IELTS' },
                        { level: 'Doctoral (PhD)', score: '6.5+ IELTS' }
                      ].map((req, i) => (
                        <motion.div 
                          key={i} 
                          whileHover={{ y: -5 }}
                ...
                >
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    <motion.div variants={fadeUp} className="bg-white p-8 rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100">
                      ...
                      <ul className="space-y-4">
                        {[
                          'Undergraduate students generally have limited work opportunities during their first year.',
                          'Eligible international students may apply for a work permit in accordance with Turkish labour regulations.',
                          'Graduate students may have additional opportunities for research, teaching, or university-based employment.'
                        ].map((text, i) => (
                          <li key={i} className="flex items-start gap-3">
                    ...
                    <motion.div variants={fadeUp} className="bg-gray-900 p-8 rounded-3xl shadow-xl text-white">
                      ...
                      <p className="text-sm text-gray-300 mb-4">
                        Turkey offers graduates opportunities to build careers in a rapidly growing economy.
                      </p>
                      <ul className="space-y-4">
                        {[
                          'Seek employment with Turkish or international companies.',
                          'Pursue opportunities in engineering, healthcare, technology, finance, tourism, and more.',
                          'Continue postgraduate or doctoral studies.'
                        ].map((text, i) => (
                          <li key={i} className="flex items-start gap-3">
              ...
              <div className="lg:col-span-4 space-y-6">
                    ...
                    <div className="space-y-6">
                      <div>
                        ...
                        <div className="space-y-3">
                          {[
                            { level: 'Associate Degrees', fee: '$500–$3,000' },
                            { level: 'Bachelor\'s Degrees', fee: '$1,000–$8,000' },
                            { level: 'Medicine & Dentistry', fee: '$10,000–$30,000' },
                            { level: 'Master\'s Degrees', fee: '$2,000–$10,000' },
                            { level: 'Doctoral (PhD)', fee: '$3,000–$12,000' }
                          ].map((item, i) => (
                      ...
                      <div>
                        ...
                        <div className="space-y-3">
                          {[
                            { item: 'Accommodation', cost: '$1,800–$4,500' },
                            { item: 'Food', cost: '$1,200–$2,500' },
                            { item: 'Transportation', cost: '$300–$800' },
                            { item: 'Utilities & Internet', cost: '$500–$900' },
                            { item: 'Personal Expenses', cost: '$1,000–$2,000' }
                          ].map((item, i) => (
                            <div key={i} className="flex justify-between items-center bg-gray-50 p-3 rounded-xl border border-gray-100">
                  ...
                  <div className="sticky top-24 z-10">
                    ...
                    <p className="text-white/90 text-sm mb-6 relative z-10 leading-relaxed font-medium">
                      We provide expert guidance to help you choose the right university and pathway in Turkey.
                    </p>
