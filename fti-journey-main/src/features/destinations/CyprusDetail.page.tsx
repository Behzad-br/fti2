        ...
        <section ref={heroRef} className="relative h-[70vh] min-h-[600px] flex items-center justify-center overflow-hidden rounded-b-[3rem] shadow-2xl">
          ...
          <div className="container relative z-10 mx-auto px-4 text-center mt-16">
            ...
            >
              ...
              <span className="text-white font-medium tracking-wide text-sm uppercase">Affordable European Education</span>
            </motion.div>
            ...
            >
              Study in <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-400 to-orange-500">Cyprus</span>
            </motion.h1>
            ...
            >
              International Recognition. Bright Career Opportunities. Gateway to Europe.
            </motion.p>
          </div>
          ...
          >
            {[
              { icon: Building, label: 'Quality Assured', value: 'CYQAA Regulated' },
              { icon: Globe, label: 'Location', value: 'Crossroads of Europe' },
              { icon: DollarSign, label: 'Cost of Living', value: 'Highly Affordable' }
            ].map((stat, i) => (
              ...
              <div className="lg:col-span-8 space-y-16">
                ...
                >
                  <motion.div variants={fadeUp} className="flex items-center gap-4 mb-6">
                    ...
                    <h2 className="text-3xl md:text-4xl font-black text-foreground tracking-tight">Discover Cyprus</h2>
                  </motion.div>
                  
                  <motion.p variants={fadeUp} className="text-lg text-muted-foreground leading-relaxed mb-6">
                    Cyprus has become an increasingly popular destination for international students seeking high-quality education, affordable tuition fees, and internationally recognised qualifications. Strategically located at the crossroads of Europe, Asia, and Africa, Cyprus offers a modern education system, English-taught programmes, and a welcoming multicultural environment.
                  </motion.p>
                  <motion.p variants={fadeUp} className="text-lg text-muted-foreground leading-relaxed mb-10">
                    Home to internationally accredited universities and higher education institutions, Cyprus provides students with excellent academic opportunities while serving as a gateway to Europe and global employment markets.
                  </motion.p>
                  ...
                  <motion.div variants={fadeUp} className="grid grid-cols-1 md:grid-cols-3 gap-4 h-[400px]">
                    <div className="md:col-span-2 h-full rounded-3xl overflow-hidden group relative shadow-lg">
                      <img src="https://images.unsplash.com/photo-1507525428034-b723cf961d3e?auto=format&fit=crop&w=1200" alt="Paphos" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" />
                      <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent flex items-end p-6">
                        <span className="text-white font-bold text-xl drop-shadow-md">Beautiful Coastlines</span>
                      </div>
                    </div>
                    <div className="grid grid-rows-2 gap-4 h-full">
                      ...
                      <div className="rounded-3xl overflow-hidden group relative shadow-lg bg-gradient-to-br from-primary to-orange-600 flex items-center justify-center p-6 text-center">
                        <div>
                          <p className="text-4xl font-black text-white mb-2">CYQAA</p>
                ...
                >
                  <motion.div variants={fadeUp} className="flex items-center gap-4 mb-8">
                    ...
                    <h2 className="text-3xl font-bold text-foreground">Why Study in Cyprus?</h2>
                  </motion.div>
                ...
                >
                  ...
                  <motion.div variants={fadeUp} className="flex items-center gap-4 mb-8 relative z-10">
                    ...
                    <div>
                      <h2 className="text-3xl font-bold text-foreground">Cyprus Education System</h2>
                      <p className="text-muted-foreground mt-1 text-sm">Regulated by the Ministry of Education and accredited through CYQAA.</p>
                    </div>
                  </motion.div>
                  ...
                  <div className="grid md:grid-cols-2 gap-10 relative z-10">
                    <div>
                      ...
                      <div className="flex flex-wrap gap-2">
                        {['Foundation Programmes', 'Certificates & Diplomas', 'Higher Diplomas', 'Bachelor\'s Degrees', 'Postgraduate Diplomas', 'Master\'s Degrees', 'Doctoral (PhD) Programmes'].map((level, i) => (
                    ...
                    {[
                      {
                        ...
                        icon: Briefcase,
                        items: ['Business Admin', 'Accounting', 'Finance', 'Marketing', 'Human Resource Management', 'International Business']
                      },
                      {
                      ...
                      },
                      {
                        title: 'Engineering',
                        icon: Building,
                        items: ['Civil Engineering', 'Mechanical', 'Electrical', 'Architecture', 'Environmental Engineering']
                      },
                      {
                        title: 'Health Sciences',
                        icon: FlaskConical,
                        items: ['Nursing', 'Pharmacy', 'Public Health', 'Physiotherapy', 'Biomedical Sciences', 'Nutrition']
                      },
                      {
                        title: 'Hospitality & Tourism',
                        icon: MapPin,
                        items: ['Hotel Management', 'Tourism Management', 'Culinary Arts', 'Event Management']
                      },
                      {
                        title: 'Arts & Social Sciences',
                        icon: Palette,
                        items: ['Interior Design', 'Graphic Design', 'Psychology', 'International Relations', 'Education', 'Media & Communication', 'Law']
                      }
                    ].map((category, i) => (
                      <motion.div 
                        key={i}
                ...
                >
                  ...
                  <div className="grid md:grid-cols-2 gap-6 mb-12">
                    <motion.div variants={fadeUp} className="group relative bg-white p-8 rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100 hover:shadow-xl transition-all duration-300">
                      <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-gray-200 to-gray-300 group-hover:from-cyan-500 group-hover:to-blue-500 transition-all duration-500 rounded-t-3xl" />
                ...
                >
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    <motion.div variants={fadeUp} className="bg-white p-8 rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100">
                      ...
                      <p className="text-sm text-muted-foreground mb-4">Eligible students may work part-time subject to immigration and employment regulations.</p>
                      <ul className="space-y-4">
                        {[
                          'Work part-time during studies in approved sectors.',
                          'Work additional hours during official university holidays.',
                          'Sectors: Hospitality, Tourism, Retail, Customer Service, Admin.'
                        ].map((text, i) => (
                          <li key={i} className="flex items-start gap-3">
                    ...
                    <motion.div variants={fadeUp} className="bg-gray-900 p-8 rounded-3xl shadow-xl text-white">
                      ...
                      <p className="text-sm text-gray-300 mb-4">
                        Cyprus offers graduates opportunities to gain valuable international experience in sectors like business, finance, and tourism.
                      </p>
                      <ul className="space-y-4">
                        {[
                          'Seek employment in Cyprus where eligible.',
                          'Pursue career opportunities across Europe.',
                          'Build international experience with multinational organisations.',
              ...
              <div className="lg:col-span-4 space-y-6">
                    ...
                    <div className="space-y-6">
                      <div>
                        ...
                        <div className="space-y-3">
                          {[
                            { level: 'Foundation & Diploma', fee: '€3.5k–€6.5k' },
                            { level: 'Bachelor\'s Degrees', fee: '€4k–€10k' },
                            { level: 'Master\'s Degrees', fee: '€5k–€12k' },
                            { level: 'Doctoral (PhD)', fee: '€6k–€12k' }
                          ].map((item, i) => (
                      ...
                      <div>
                        ...
                        <div className="space-y-3">
                          {[
                            { item: 'Accommodation', cost: '€3,500–€7,000' },
                            { item: 'Food', cost: '€2,000–€3,500' },
                            { item: 'Transportation', cost: '€500–€1,000' },
                    ...
                    <div className="relative z-10">
                      ...
                      <ul className="space-y-4">
                        {[
                          ...
                          'Faculty & Graduate Funding',
                          'Early Bird Tuition Discounts',
                          'Sports & Promotional Scholarships'
                        ].map((sch, i) => (
                      ...
                      <p className="text-xs text-gray-400 mt-4 italic">*Scholarships may cover 25% to 100% of tuition fees.</p>
                    </div>
                  </motion.div>
                  ...
                  <div className="sticky top-24 z-10">
                    ...
                    <p className="text-white/90 text-sm mb-6 relative z-10 leading-relaxed font-medium">
                      We provide comprehensive guidance to help you achieve your international education goals in Cyprus.
                    </p>
