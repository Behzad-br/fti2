      ...
      <div className="page-transition bg-[#FAFAFA] min-h-screen">
        ...
        <section ref={heroRef} className="relative h-[70vh] min-h-[600px] flex items-center justify-center overflow-hidden rounded-b-[3rem] shadow-2xl">
          <motion.div style={{ y, opacity }} className="absolute inset-0 w-full h-full">
            <img
              src="https://images.unsplash.com/photo-1509356843151-3e7d96241e11?auto=format&fit=crop&w=1200"
              alt="Study in Sweden"
          ...
          <div className="container relative z-10 mx-auto px-4 text-center mt-16">
            ...
            >
              ...
              <span className="text-white font-medium tracking-wide text-sm uppercase">Innovation & Sustainability</span>
            </motion.div>
            ...
            >
              Study in <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-400 to-orange-500">Sweden</span>
            </motion.h1>
            ...
            >
              Innovation. Sustainability. World-Class Education.
            </motion.p>
          </div>
          ...
          >
            {[
              { icon: Building, label: 'Quality Assured', value: 'UKÄ Regulated' },
              { icon: Globe, label: 'Sustainability', value: 'Global Leader' },
              { icon: Lightbulb, label: 'Education Style', value: 'Highly Innovative' }
            ].map((stat, i) => (
              ...
              <div className="lg:col-span-8 space-y-16">
                ...
                >
                  <motion.div variants={fadeUp} className="flex items-center gap-4 mb-6">
                    ...
                    <h2 className="text-3xl md:text-4xl font-black text-foreground tracking-tight">Discover Sweden</h2>
                  </motion.div>
                  
                  <motion.p variants={fadeUp} className="text-lg text-muted-foreground leading-relaxed mb-6">
                    Sweden is one of Europe's leading study destinations, renowned for its innovative education system, cutting-edge research, and commitment to sustainability. Home to globally respected universities and a strong culture of creativity, Sweden provides international students with an education that emphasizes critical thinking, collaboration, and practical problem-solving.
                  </motion.p>
                  <motion.p variants={fadeUp} className="text-lg text-muted-foreground leading-relaxed mb-10">
                    With a high standard of living, an inclusive society, and close connections between academia and industry, Sweden offers students an outstanding platform for academic excellence and global career development.
                  </motion.p>
                  ...
                  <motion.div variants={fadeUp} className="grid grid-cols-1 md:grid-cols-3 gap-4 h-[400px]">
                    <div className="md:col-span-2 h-full rounded-3xl overflow-hidden group relative shadow-lg">
                      <img src="https://images.unsplash.com/photo-1509356843151-3e7d96241e11?auto=format&fit=crop&w=1200" alt="Stockholm" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" />
                      <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent flex items-end p-6">
                        <span className="text-white font-bold text-xl drop-shadow-md">Beautiful Stockholm</span>
                      </div>
                    </div>
                    <div className="grid grid-rows-2 gap-4 h-full">
                      ...
                      <div className="rounded-3xl overflow-hidden group relative shadow-lg bg-gradient-to-br from-primary to-orange-600 flex items-center justify-center p-6 text-center">
                        <div>
                          <p className="text-4xl font-black text-white mb-2">UKÄ</p>
                          <p className="text-white/80 text-sm font-medium">Quality Education</p>
                        </div>
                      </div>
                    </div>
                  </motion.div>
                ...
                >
                  <motion.div variants={fadeUp} className="flex items-center gap-4 mb-8">
                    ...
                    <h2 className="text-3xl font-bold text-foreground">Why Study in Sweden?</h2>
                  </motion.div>
                  ...
                  <div className="grid sm:grid-cols-2 gap-4">
                    {[
                      ...
                      'Innovative and student-centred teaching',
                      ...
                      'Excellent English-taught programmes',
                ...
                >
                  ...
                  <motion.div variants={fadeUp} className="flex items-center gap-4 mb-8 relative z-10">
                    ...
                    <div>
                      <h2 className="text-3xl font-bold text-foreground">Swedish Education System</h2>
                      <p className="text-muted-foreground mt-1 text-sm">Regulated by the Swedish Higher Education Authority (UKÄ) ensuring academic excellence.</p>
                    </div>
                  </motion.div>
                  ...
                  <div className="grid md:grid-cols-2 gap-10 relative z-10">
                    <div>
                      ...
                      <div className="flex flex-wrap gap-2">
                        {['Foundation Programmes', 'Bachelor\'s Degrees', 'Master\'s Degrees', 'Doctoral (PhD) Programmes', 'Professional Degrees', 'Exchange Programmes'].map((level, i) => (
                    ...
                    {[
                      {
                        ...
                        icon: Briefcase,
                        items: ['International Business', 'Business Admin', 'Finance', 'Accounting', 'Marketing', 'Entrepreneurship', 'Supply Chain']
                      },
                      {
                        title: 'Information Technology',
                        icon: Lightbulb,
                        items: ['Computer Science', 'AI & Cyber Security', 'Software Engineering', 'Data Science', 'Machine Learning']
                      },
                      {
                        title: 'Engineering',
                        icon: Building,
                        items: ['Mechanical', 'Civil', 'Electrical', 'Automotive', 'Industrial', 'Environmental', 'Sustainable Energy']
                      },
                      {
                        title: 'Sustainability & Environment',
                        icon: FlaskConical,
                        items: ['Environmental Science', 'Climate Change Studies', 'Sustainable Development', 'Renewable Energy', 'Circular Economy']
                      },
                      {
                        title: 'Health & Social Sciences',
                        icon: CheckCircle,
                        items: ['Public/Global Health', 'Biomedical Sciences', 'Intl Relations', 'Political Science', 'Economics', 'Psychology']
                      },
                      {
                        title: 'Design & Creative Arts',
                        icon: Palette,
                        items: ['Industrial Design', 'Graphic Design', 'Architecture', 'Product Design', 'Interaction Design']
                      }
                    ].map((category, i) => (
                      <motion.div 
                        key={i}
                ...
                >
                  ...
                  <div className="grid md:grid-cols-2 gap-6 mb-12">
                    <motion.div variants={fadeUp} className="group relative bg-white p-8 rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100 hover:shadow-xl transition-all duration-300">
                      <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-gray-200 to-gray-300 group-hover:from-blue-500 group-hover:to-yellow-400 transition-all duration-500 rounded-t-3xl" />
                      <h3 className="text-2xl font-bold text-foreground mb-6">Bachelor's Programmes</h3>
                    ...
                    <motion.div variants={fadeUp} className="group relative bg-white p-8 rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100 hover:shadow-xl transition-all duration-300">
                      <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-gray-200 to-gray-300 group-hover:from-blue-500 group-hover:to-yellow-400 transition-all duration-500 rounded-t-3xl" />
                      <h3 className="text-2xl font-bold text-foreground mb-6">Master's Programmes</h3>
                      <ul className="space-y-4">
                        {[
                  ...
                  <motion.div variants={fadeUp} className="bg-gradient-to-br from-amber-400 to-orange-500 rounded-[2rem] p-8 md:p-10 border border-primary/20 relative overflow-hidden">
                    ...
                    <p className="text-muted-foreground mb-6">
                      Accepted tests: IELTS Academic, TOEFL iBT, PTE Academic, Cambridge English Qualifications.
                    </p>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      {[
                        { level: 'Bachelor\'s Degree', score: '6.5 IELTS' },
                ...
                >
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    <motion.div variants={fadeUp} className="bg-white p-8 rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100">
                      ...
                      <p className="text-sm text-muted-foreground mb-4">International students in Sweden are generally permitted to work while studying without a statutory hour limit.</p>
                      <ul className="space-y-4">
                        {[
                          'No statutory limit on hours (but academic progress must be maintained).',
                          'Sectors: IT, Research, Hospitality, Retail, Admin.',
                          'Knowledge of Swedish may improve opportunities, but many workplaces operate in English.'
                        ].map((text, i) => (
                          <li key={i} className="flex items-start gap-3">
                    ...
                    <motion.div variants={fadeUp} className="bg-gray-900 p-8 rounded-3xl shadow-xl text-white">
                      <h3 className="text-xl font-bold mb-4 flex items-center gap-2">
                        <Award className="w-5 h-5 text-amber-400" /> Post-Study Work
                      </h3>
                      <p className="text-sm text-gray-300 mb-4">
                        Sweden provides opportunities for eligible international graduates to remain and seek employment.
                      </p>
                      <ul className="space-y-4">
                        {[
                          'Apply for a residence permit to seek employment or establish a business.',
                          'Transition to a work permit upon securing eligible employment.',
                          'Explore long-term residence opportunities subject to migration policies.'
                        ].map((text, i) => (
                          <li key={i} className="flex items-start gap-3">
              ...
              <div className="lg:col-span-4 space-y-6">
                  ...
                  >
                    ...
                    <div className="space-y-6">
                      <div>
                        <p className="text-sm text-muted-foreground uppercase tracking-wider font-bold mb-3">Tuition Fees (Yearly SEK)</p>
                        <div className="space-y-3">
                          {[
                            { level: 'Bachelor\'s Degrees', fee: '80k–180k SEK' },
                            { level: 'Master\'s Degrees', fee: '90k–220k SEK' },
                            { level: 'Professional Progs', fee: '100k–250k SEK' }
                          ].map((item, i) => (
                      ...
                      <div>
                        <p className="text-sm text-muted-foreground uppercase tracking-wider font-bold mb-3">Living Cost (Yearly SEK)</p>
                        <div className="space-y-3">
                          {[
                            { item: 'Accommodation', cost: '45,000–75,000' },
                            { item: 'Food', cost: '24,000–36,000' },
                            { item: 'Transportation', cost: '6,000–10,000' },
                            { item: 'Utilities & Internet', cost: '6,000–12,000' },
                            { item: 'Personal Expenses', cost: '18,000–30,000' }
                          ].map((item, i) => (
                            <div key={i} className="flex justify-between items-center bg-gray-50 p-3 rounded-xl border border-gray-100">
                  ...
                  >
                    ...
                    <div className="relative z-10">
                      ...
                      <p className="text-xs text-gray-400 mt-4 italic">*Financial support in Sweden is primarily awarded on academic merit.</p>
                    </div>
                  </motion.div>
                  ...
                  <div className="sticky top-24 z-10">
                    ...
                    <p className="text-white/90 text-sm mb-6 relative z-10 leading-relaxed font-medium">
                      We provide personalised guidance to help you achieve your study abroad aspirations in Sweden.
                    </p>
