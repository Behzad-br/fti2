      ...
      <div className="page-transition bg-[#FAFAFA] min-h-screen">
        ...
        <section ref={heroRef} className="relative h-[70vh] min-h-[600px] flex items-center justify-center overflow-hidden rounded-b-[3rem] shadow-2xl">
          <motion.div style={{ y, opacity }} className="absolute inset-0 w-full h-full">
            <img
              src="https://images.unsplash.com/photo-1596422846543-75c6fc197f07?auto=format&fit=crop&w=1200"
          ...
          <div className="container relative z-10 mx-auto px-4 text-center mt-16">
            ...
            >
              ...
              <span className="text-white font-medium tracking-wide text-sm uppercase">Asian Excellence</span>
            </motion.div>
            ...
            >
              Study in <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-400 to-orange-500">Malaysia</span>
            </motion.h1>
            ...
            >
              Affordable Education. Global Recognition. Asian Excellence.
            </motion.p>
          </div>
          ...
          >
            {[
              { icon: Building, label: 'Regulated by MQA', value: 'High Standards' },
              { icon: Globe, label: 'Location', value: 'Asia-Pacific Hub' },
              { icon: DollarSign, label: 'Tuition & Living', value: 'Highly Affordable' }
            ].map((stat, i) => (
              ...
              <div className="lg:col-span-8 space-y-16">
                ...
                >
                  <motion.div variants={fadeUp} className="flex items-center gap-4 mb-6">
                    ...
                    <h2 className="text-3xl md:text-4xl font-black text-foreground tracking-tight">Discover Malaysia</h2>
                  </motion.div>
                  
                  <motion.p variants={fadeUp} className="text-lg text-muted-foreground leading-relaxed mb-6">
                    Malaysia has emerged as one of Asia's leading destinations for international education, offering globally recognised qualifications, affordable tuition fees, and an excellent multicultural environment. With internationally accredited universities and partnerships with prestigious institutions from the UK, Australia, and other countries, Malaysia provides high-quality education at a significantly lower cost.
                  </motion.p>
                  <motion.p variants={fadeUp} className="text-lg text-muted-foreground leading-relaxed mb-10">
                    Its strategic location, modern infrastructure, English-medium instruction, and vibrant student community make Malaysia an ideal choice for students seeking strong career prospects.
                  </motion.p>
                  ...
                  <motion.div variants={fadeUp} className="grid grid-cols-1 md:grid-cols-3 gap-4 h-[400px]">
                    <div className="md:col-span-2 h-full rounded-3xl overflow-hidden group relative shadow-lg">
                      <img src="https://images.unsplash.com/photo-1596422846543-75c6fc197f07?auto=format&fit=crop&w=1200" alt="Kuala Lumpur" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" />
                      <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent flex items-end p-6">
                        <span className="text-white font-bold text-xl drop-shadow-md">Vibrant Kuala Lumpur</span>
                      </div>
                    </div>
                    <div className="grid grid-rows-2 gap-4 h-full">
                      ...
                      <div className="rounded-3xl overflow-hidden group relative shadow-lg bg-gradient-to-br from-primary to-orange-600 flex items-center justify-center p-6 text-center">
                        <div>
                          <p className="text-4xl font-black text-white mb-2">MQA</p>
                          <p className="text-white/80 text-sm font-medium">Quality Accredited</p>
                        </div>
                      </div>
                    </div>
                  </motion.div>
                ...
                >
                  <motion.div variants={fadeUp} className="flex items-center gap-4 mb-8">
                    ...
                    <h2 className="text-3xl font-bold text-foreground">Why Study in Malaysia?</h2>
                  </motion.div>
                ...
                >
                  ...
                  <motion.div variants={fadeUp} className="flex items-center gap-4 mb-8 relative z-10">
                    ...
                    <div>
                      <h2 className="text-3xl font-bold text-foreground">Malaysian Education System</h2>
                      <p className="text-muted-foreground mt-1 text-sm">Regulated by MOHE and MQA ensuring high academic standards.</p>
                    </div>
                  </motion.div>
                  ...
                  <div className="grid md:grid-cols-2 gap-10 relative z-10">
                    <div>
                      ...
                      <div className="flex flex-wrap gap-2">
                        {['English Programmes', 'Foundation', 'Certificates & Diplomas', 'Bachelor\'s Degrees', 'Postgraduate Diplomas', 'Master\'s Degrees', 'Doctoral (PhD)'].map((level, i) => (
                    ...
                    {[
                      {
                        ...
                        icon: Briefcase,
                        items: ['Business Admin', 'Accounting', 'Finance', 'Marketing', 'International Business', 'Logistics & Supply Chain', 'Project Management']
                      },
                      {
                        title: 'Information Technology',
                        icon: Lightbulb,
                        items: ['Computer Science', 'AI & Cyber Security', 'Data Science', 'Software Engineering', 'Information Systems', 'Cloud Computing']
                      },
                      {
                        title: 'Engineering',
                        icon: Building,
                        items: ['Civil Engineering', 'Mechanical', 'Electrical & Electronic', 'Chemical', 'Mechatronics', 'Petroleum Engineering']
                      },
                      {
                        title: 'Health Sciences',
                        icon: CheckCircle,
                        items: ['Nursing', 'Pharmacy', 'Biomedical Science', 'Public Health', 'Nutrition', 'Medical Laboratory Technology']
                      },
                      {
                      ...
                      },
                      {
                        ...
                        icon: Palette,
                        items: ['Architecture', 'Interior Design', 'Graphic Design', 'Multimedia Design', 'Animation']
                      }
                    ].map((category, i) => (
                      <motion.div 
                        key={i}
                ...
                >
                  ...
                  <div className="grid md:grid-cols-2 gap-6 mb-12">
                    <motion.div variants={fadeUp} className="group relative bg-white p-8 rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100 hover:shadow-xl transition-all duration-300">
                      <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-gray-200 to-gray-300 group-hover:from-blue-500 group-hover:to-blue-400 transition-all duration-500 rounded-t-3xl" />
                    ...
                    <motion.div variants={fadeUp} className="group relative bg-white p-8 rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100 hover:shadow-xl transition-all duration-300">
                      ...
                      <ul className="space-y-4">
                        {[
                          ...
                          'Relevant work experience (selected professional programmes)'
                        ].map((req, i) => (
                          <li key={i} className="flex items-start gap-3">
                            <div className="mt-1 w-5 h-5 rounded-full bg-primary/10 flex items-center justify-center shrink-0">
                              <div className="w-2 h-2 rounded-full bg-primary" />
                  ...
                  <motion.div variants={fadeUp} className="bg-gradient-to-br from-amber-400 to-orange-500 rounded-[2rem] p-8 md:p-10 border border-primary/20 relative overflow-hidden">
                    ...
                    <p className="text-muted-foreground mb-6">
                      Accepted tests: IELTS Academic, PTE Academic, TOEFL iBT, MUET, Cambridge English, Duolingo (selected institutions).
                    </p>
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                      {[
                        { level: 'Diploma', score: '5.0–5.5 IELTS' },
                        { level: 'Bachelor\'s Degree', score: '5.5–6.0 IELTS' },
                        { level: 'Master\'s Degree', score: '6.0–6.5 IELTS' },
                        { level: 'Nursing/Health', score: '6.5+ IELTS' }
                      ].map((req, i) => (
                        <motion.div 
                          key={i} 
                          whileHover={{ y: -5 }}
                ...
                >
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    <motion.div variants={fadeUp} className="bg-white p-8 rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100">
                      ...
                      <p className="text-sm text-muted-foreground mb-4">Eligible international students may work part-time subject to Immigration regulations.</p>
                      <ul className="space-y-4">
                        {[
                          'Work up to 20 hours per week during semester breaks or holidays.',
                          'Approved sectors: Hospitality, Restaurants, Retail, Mini markets.',
                          'Must comply with latest immigration regulations and obtain approvals.'
                        ].map((text, i) => (
                          <li key={i} className="flex items-start gap-3">
                    ...
                    <motion.div variants={fadeUp} className="bg-gray-900 p-8 rounded-3xl shadow-xl text-white">
                      ...
                      <p className="text-sm text-gray-300 mb-4">
                        Malaysia offers graduates opportunities to gain professional experience across Southeast Asia.
                      </p>
                      <ul className="space-y-4">
                        {[
                          'Seek employment with Malaysian and international employers.',
                          'Pursue regional career opportunities within ASEAN.',
                          'Continue higher education or research.',
                          'Explore pathways in accordance with employment regulations.'
                        ].map((text, i) => (
                          <li key={i} className="flex items-start gap-3">
              ...
              <div className="lg:col-span-4 space-y-6">
                  ...
                  >
                    ...
                    <div className="space-y-6">
                      <div>
                        <p className="text-sm text-muted-foreground uppercase tracking-wider font-bold mb-3">Tuition Fees (Yearly MYR)</p>
                        <div className="space-y-3">
                          {[
                            { level: 'English Programmes', fee: 'RM 8k–15k' },
                            { level: 'Diploma Programmes', fee: 'RM 10k–25k' },
                            { level: 'Bachelor\'s Degrees', fee: 'RM 15k–45k' },
                            { level: 'Master\'s Degrees', fee: 'RM 18k–50k' },
                            { level: 'Doctoral (PhD)', fee: 'RM 15k–35k' }
                          ].map((item, i) => (
                      ...
                      <div>
                        <p className="text-sm text-muted-foreground uppercase tracking-wider font-bold mb-3">Living Cost (Yearly MYR)</p>
                        <div className="space-y-3">
                          {[
                            { item: 'Accommodation', cost: 'RM 6k–15k' },
                            { item: 'Food', cost: 'RM 4,000–8,000' },
                            { item: 'Transportation', cost: 'RM 1,000–3,000' },
                            { item: 'Utilities & Internet', cost: 'RM 1,500–3,000' },
                            { item: 'Personal Expenses', cost: 'RM 3,000–6,000' }
                          ].map((item, i) => (
                            <div key={i} className="flex justify-between items-center bg-gray-50 p-3 rounded-xl border border-gray-100">
                  ...
                  <div className="sticky top-24 z-10">
                    ...
                    <p className="text-white/90 text-sm mb-6 relative z-10 leading-relaxed font-medium">
                      We provide comprehensive guidance throughout your Malaysian education journey.
                    </p>
                    <ul className="text-sm text-white/90 space-y-2 mb-8 text-left bg-black/20 p-4 rounded-xl relative z-10">
                      ...
                      <li className="flex items-start gap-2"><CheckCircle className="h-4 w-4 text-amber-400 shrink-0 mt-0.5" /> Accommodation Guidance</li>
                    </ul>
                    <Button 
