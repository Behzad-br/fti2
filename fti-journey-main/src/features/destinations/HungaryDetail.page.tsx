      ...
      <div className="page-transition bg-[#FAFAFA] min-h-screen">
        ...
        <section ref={heroRef} className="relative h-[70vh] min-h-[600px] flex items-center justify-center overflow-hidden rounded-b-[3rem] shadow-2xl">
          <motion.div style={{ y, opacity }} className="absolute inset-0 w-full h-full">
            <img
              src="https://images.unsplash.com/photo-1541849546-216549ae216d?auto=format&fit=crop&w=1200"
              alt="Study in Hungary - Budapest"
          ...
          <div className="container relative z-10 mx-auto px-4 text-center mt-16">
            ...
            >
              ...
              <span className="text-white font-medium tracking-wide text-sm uppercase">European Excellence</span>
            </motion.div>
            ...
            >
              Study in <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-400 to-orange-500">Hungary</span>
            </motion.h1>
            ...
            >
              European Excellence. Affordable Education. Global Opportunities.
            </motion.p>
          </div>
          ...
          >
            {[
              { icon: Building, label: 'Bologna Process', value: 'EU Member' },
              { icon: Globe, label: 'Intl. Community', value: 'Vibrant' },
              { icon: Award, label: 'Centuries Old', value: 'Heritage' }
            ].map((stat, i) => (
              ...
              <div className="lg:col-span-8 space-y-16">
                ...
                >
                  <motion.div variants={fadeUp} className="flex items-center gap-4 mb-6">
                    ...
                    <h2 className="text-3xl md:text-4xl font-black text-foreground tracking-tight">Discover Hungary</h2>
                  </motion.div>
                  
                  <motion.p variants={fadeUp} className="text-lg text-muted-foreground leading-relaxed mb-6">
                    Hungary has become one of Europe's most attractive study destinations, offering internationally recognised qualifications, affordable tuition fees, and a rich academic tradition. With universities dating back several centuries and programmes taught in English across a wide range of disciplines, Hungary provides students with a high-quality European education in a safe, vibrant, and culturally diverse environment.
                  </motion.p>
                  <motion.p variants={fadeUp} className="text-lg text-muted-foreground leading-relaxed mb-10">
                    As a member of the European Union and the European Higher Education Area (EHEA), Hungary follows the Bologna Process, ensuring that its qualifications are recognised across Europe and many other parts of the world.
                  </motion.p>
                  ...
                  <motion.div variants={fadeUp} className="grid grid-cols-1 md:grid-cols-3 gap-4 h-[400px]">
                    <div className="md:col-span-2 h-full rounded-3xl overflow-hidden group relative shadow-lg">
                      <img src="https://images.unsplash.com/photo-1541849546-216549ae216d?auto=format&fit=crop&w=1200" alt="Budapest" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" />
                      <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent flex items-end p-6">
                        <span className="text-white font-bold text-xl drop-shadow-md">Historic Budapest</span>
                      </div>
                    </div>
                    <div className="grid grid-rows-2 gap-4 h-full">
                      <div className="rounded-3xl overflow-hidden group relative shadow-lg">
                        <img src="https://images.unsplash.com/photo-1522202176988-66273c2fd55f?auto=format&fit=crop&q=80&w=600" alt="Culture" className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700" />
                      </div>
                      <div className="rounded-3xl overflow-hidden group relative shadow-lg bg-gradient-to-br from-primary to-orange-600 flex items-center justify-center p-6 text-center">
                        <div>
                          ...
                          <p className="text-white/80 text-sm font-medium">Bologna Process</p>
                        </div>
                      </div>
                    </div>
                  </motion.div>
                ...
                >
                  <motion.div variants={fadeUp} className="flex items-center gap-4 mb-8">
                    ...
                    <h2 className="text-3xl font-bold text-foreground">Why Study in Hungary?</h2>
                  </motion.div>
                  
                  <div className="grid sm:grid-cols-2 gap-4">
                    {[
                      'Internationally recognised European qualifications',
                      'Affordable tuition fees and living costs',
                      'English-taught degree programmes',
                      'Modern universities with strong research facilities',
                      'Member of the European Higher Education Area',
                      'Safe and student-friendly environment',
                      'Rich cultural and historical heritage',
                      'Excellent value for money',
                      'Opportunities for international mobility and research'
                    ].map((benefit, i) => (
                      <motion.div 
                        key={i} 
                        variants={fadeUp}
                ...
                {/* 3. Study Levels & Popular Programs */}
                <motion.div
                  initial="hidden"
                  animate={isVisible ? "visible" : "hidden"}
                  variants={staggerContainer}
                ...
                >
                  ...
                  <motion.div variants={fadeUp} className="flex items-center gap-4 mb-8 relative z-10">
                    ...
                    <div>
                      <h2 className="text-3xl font-bold text-foreground">Hungary Education System</h2>
                      <p className="text-muted-foreground mt-1 text-sm">Regulated by the Hungarian Ministry of Culture and Innovation and accredited by the Hungarian Accreditation Committee (MAB).</p>
                    </div>
                  </motion.div>
                  ...
                  <div className="grid md:grid-cols-2 gap-10 relative z-10">
                    <div>
                      ...
                      <div className="flex flex-wrap gap-2">
                        {['Foundation Programmes', 'Bachelor\'s Degrees', 'Master\'s Degrees', 'Doctoral (PhD) Programmes', 'Professional Degrees (Medicine, Dentistry, etc.)'].map((level, i) => (
                    ...
                    <div>
                      <h3 className="text-xl font-bold text-foreground mb-5 flex items-center gap-2">
                        <ArrowRight className="h-5 w-5 text-primary" /> Universities Focus On:
                      </h3>
                    ...
                    {[
                      {
                        ...
                        icon: Briefcase,
                        items: ['Business Administration', 'International Business', 'Accounting', 'Finance', 'Marketing', 'Human Resource Management', 'Supply Chain Management']
                      },
                      {
                        title: 'Information Technology',
                        icon: Lightbulb,
                        items: ['Computer Science', 'Software Engineering', 'Artificial Intelligence', 'Cyber Security', 'Data Science', 'Information Systems']
                      },
                      {
                        title: 'Engineering',
                        icon: Building,
                        items: ['Civil Engineering', 'Mechanical', 'Electrical', 'Chemical', 'Environmental', 'Mechatronics']
                      },
                      {
                        title: 'Medicine & Health Sciences',
                        icon: CheckCircle,
                        items: ['Medicine (MBBS)', 'Dentistry', 'Pharmacy', 'Nursing', 'Physiotherapy', 'Public Health', 'Biomedical Sciences']
                      },
                      {
                        title: 'Science',
                        icon: FlaskConical,
                        items: ['Biotechnology', 'Environmental Science', 'Physics', 'Chemistry', 'Mathematics']
                      },
                      {
                      ...
                      },
                      {
                        title: 'Arts & Design',
                        icon: Palette,
                        items: ['Architecture', 'Interior Design', 'Graphic Design', 'Fine Arts', 'Music']
                      }
                    ].map((category, i) => (
                      <motion.div 
                        key={i}
                ...
                >
                  ...
                  <div className="grid md:grid-cols-2 gap-6 mb-12">
                    <motion.div variants={fadeUp} className="group relative bg-white p-8 rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100 hover:shadow-xl transition-all duration-300">
                      ...
                      <p className="text-xs text-muted-foreground mt-4 italic">*Certain programmes, particularly Medicine and Dentistry, may require entrance examinations or interviews.</p>
                    </motion.div>
                  ...
                  <motion.div variants={fadeUp} className="bg-gradient-to-br from-primary/5 to-orange-500/5 rounded-[2rem] p-8 md:p-10 border border-primary/20 relative overflow-hidden">
                    ...
                    <p className="text-muted-foreground mb-6">
                      Accepted tests: IELTS Academic, TOEFL iBT, PTE Academic, Cambridge English Qualifications, Duolingo English Test (accepted by selected institutions).
                    </p>
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                      {[
                        ...
                        { level: 'Medicine/Health', score: '6.0-6.5 IELTS' }
                      ].map((req, i) => (
                        <motion.div 
                          key={i} 
                          whileHover={{ y: -5 }}
                          className="bg-white p-5 rounded-2xl shadow-sm border border-white relative z-10"
                        >
                ...
                >
                  <motion.div variants={fadeUp} className="flex items-center gap-4 mb-8">
                    ...
                    <h2 className="text-3xl font-bold text-foreground">Work & Career</h2>
                  </motion.div>
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    <motion.div variants={fadeUp} className="bg-white p-8 rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100">
                      ...
                      <ul className="space-y-4">
                        {[
                          'Work part-time during academic terms in accordance with employment laws.',
                          'Work additional hours during university holidays where permitted.',
                          'Opportunities in Hospitality, Retail, IT, Research Assistantships, and On-campus employment.'
                        ].map((text, i) => (
                          <li key={i} className="flex items-start gap-3">
                    ...
                    <motion.div variants={fadeUp} className="bg-gray-900 p-8 rounded-3xl shadow-xl text-white">
                      ...
                      <p className="text-sm text-gray-300 mb-4">
                        Hungary offers international graduates opportunities to gain professional experience across the European Union.
                      </p>
                      <ul className="space-y-4">
                        {[
                          'Apply for residence options to seek employment where eligible.',
                          'Gain experience with Hungarian and multinational companies.',
                          'Build international careers in engineering, healthcare, tech, business, and research.'
                        ].map((text, i) => (
                          <li key={i} className="flex items-start gap-3">
              ...
              <div className="lg:col-span-4 space-y-6">
                  ...
                  >
                    ...
                    <div className="space-y-6">
                      <div>
                        <p className="text-sm text-muted-foreground uppercase tracking-wider font-bold mb-3">Tuition Fees (Yearly)</p>
                        <div className="space-y-3">
                          {[
                            { level: 'Foundation', fee: '€3,000–€6,000' },
                            { level: 'Bachelor\'s Degrees', fee: '€3,500–€8,000' },
                            { level: 'Master\'s Degrees', fee: '€4,000–€10,000' },
                            { level: 'Medicine & Dentistry', fee: '€12k–€18k' },
                            { level: 'Doctoral (PhD)', fee: '€4,000–€8,000' }
                          ].map((item, i) => (
                      ...
                      <div>
                        <p className="text-sm text-muted-foreground uppercase tracking-wider font-bold mb-3">Living Cost (Yearly)</p>
                        <div className="space-y-3">
                          {[
                            { item: 'Accommodation', cost: '€3,000–€6,000' },
                            { item: 'Food', cost: '€2,000–€3,500' },
                            { item: 'Transportation', cost: '€300–€700' },
                            { item: 'Utilities & Internet', cost: '€800–€1,500' },
                            { item: 'Personal Expenses', cost: '€1,500–€3,000' }
                          ].map((item, i) => (
                            <div key={i} className="flex justify-between items-center bg-gray-50 p-3 rounded-xl border border-gray-100">
                  ...
                  <div className="sticky top-24 z-10">
                    ...
                    <p className="text-white/90 text-sm mb-6 relative z-10 leading-relaxed font-medium">
                      We provide expert guidance to help you choose the right university and pathway in Hungary.
                    </p>
                    <ul className="text-sm text-white/90 space-y-2 mb-8 text-left bg-black/20 p-4 rounded-xl relative z-10">
                      ...
                      <li className="flex items-start gap-2"><CheckCircle className="h-4 w-4 text-amber-400 shrink-0 mt-0.5" /> Scholarship & Admission Guidance</li>
                      <li className="flex items-start gap-2"><CheckCircle className="h-4 w-4 text-amber-400 shrink-0 mt-0.5" /> Student Visa & Documentation</li>
                    </ul>
                    <Button 
