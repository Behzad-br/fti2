      ...
      <div className="page-transition bg-[#FAFAFA] min-h-screen">
        ...
        <section ref={heroRef} className="relative h-[70vh] min-h-[600px] flex items-center justify-center overflow-hidden rounded-b-[3rem] shadow-2xl">
          ...
          <div className="container relative z-10 mx-auto px-4 text-center mt-16">
            ...
            >
              Study in <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-400 to-orange-500">Australia</span>
            </motion.h1>
            ...
            >
              Global Career Opportunities. Outstanding Quality of Life.
            </motion.p>
          </div>
          ...
          >
            {[
              { icon: Building, label: 'Top Ranked', value: 'Universities' },
              { icon: Globe, label: 'Work Experience', value: 'PSW Pathways' },
              { icon: Sun, label: 'Quality of Life', value: 'Exceptional' }
            ].map((stat, i) => (
              ...
              <div className="lg:col-span-8 space-y-16">
                ...
                >
                  <motion.div variants={fadeUp} className="flex items-center gap-4 mb-6">
                    ...
                    <h2 className="text-3xl md:text-4xl font-black text-foreground tracking-tight">Discover Australia</h2>
                  </motion.div>
                  
                  <motion.p variants={fadeUp} className="text-lg text-muted-foreground leading-relaxed mb-6">
                    Australia is one of the world's most preferred study destinations, welcoming hundreds of thousands of international students each year. Renowned for its internationally recognised qualifications, innovative teaching methods, strong research culture, and outstanding quality of life, Australia offers students an exceptional academic experience while preparing them for successful global careers.
                  </motion.p>
                  <motion.p variants={fadeUp} className="text-lg text-muted-foreground leading-relaxed mb-10">
                    With universities consistently ranked among the world's best, graduates from Australian institutions are highly valued by employers across the globe.
                  </motion.p>
                  ...
                  <motion.div variants={fadeUp} className="grid grid-cols-1 md:grid-cols-3 gap-4 h-[400px]">
                    <div className="md:col-span-2 h-full rounded-3xl overflow-hidden group relative shadow-lg">
                      <img src="https://images.unsplash.com/photo-1514395462725-fb4566210144?auto=format&fit=crop&w=1200" alt="Melbourne" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" />
                      <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent flex items-end p-6">
                        <span className="text-white font-bold text-xl drop-shadow-md">Vibrant Cities</span>
                      </div>
                    </div>
                    <div className="grid grid-rows-2 gap-4 h-full">
                      ...
                      <div className="rounded-3xl overflow-hidden group relative shadow-lg bg-gradient-to-br from-primary to-orange-600 flex items-center justify-center p-6 text-center">
                        <div>
                          ...
                          <p className="text-white/80 text-sm font-medium">Post-Study Work</p>
                        </div>
                      </div>
                    </div>
                  </motion.div>
                ...
                >
                  <motion.div variants={fadeUp} className="flex items-center gap-4 mb-8">
                    ...
                    <h2 className="text-3xl font-bold text-foreground">Why Study in Australia?</h2>
                  </motion.div>
                ...
                >
                  ...
                  <motion.div variants={fadeUp} className="flex items-center gap-4 mb-8 relative z-10">
                    ...
                    <div>
                      <h2 className="text-3xl font-bold text-foreground">Australian Education System</h2>
                      <p className="text-muted-foreground mt-1 text-sm">Regulated by the Australian Government to ensure consistent quality.</p>
                    </div>
                  </motion.div>
                  ...
                  <div className="grid md:grid-cols-2 gap-10 relative z-10">
                    <div>
                      ...
                      <div className="flex flex-wrap gap-2">
                        {['ELICOS', 'Foundation Programs', 'Diploma & Advanced Diploma', 'Bachelor\'s Degrees', 'Graduate Certificates & Diplomas', 'Master\'s Degrees (Coursework & Research)', 'Doctoral (PhD) Programs'].map((level, i) => (
                    ...
                    {[
                      {
                        ...
                        icon: Briefcase,
                        items: ['MBA', 'Accounting', 'Finance', 'Human Resource Management', 'Marketing', 'International Business', 'Project Management']
                      },
                      {
                        title: 'Information Technology',
                        icon: Lightbulb,
                        items: ['Computer Science', 'AI', 'Cyber Security', 'Data Science', 'Software Engineering', 'Cloud Computing', 'Business Analytics']
                      },
                      {
                        title: 'Engineering',
                        icon: Building,
                        items: ['Civil Engineering', 'Mechanical', 'Electrical', 'Mechatronics', 'Mining Engineering', 'Environmental']
                      },
                      {
                        title: 'Health Sciences',
                        icon: CheckCircle,
                        items: ['Nursing', 'Public Health', 'Physiotherapy', 'Pharmacy', 'Medical Laboratory Science']
                      },
                      {
                        title: 'Education',
                        icon: Award,
                        items: ['Early Childhood Education', 'Primary Education', 'Secondary Education', 'TESOL']
                      },
                      {
                        title: 'Hospitality & Creative Arts',
                        icon: MapPin,
                        items: ['Hotel Management', 'Tourism', 'Event Management', 'Graphic Design', 'Architecture', 'Interior Design']
                      }
                    ].map((category, i) => (
                      <motion.div 
                        key={i}
                    ...
                    <motion.div variants={fadeUp} className="group relative bg-white p-8 rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100 hover:shadow-xl transition-all duration-300">
                      ...
                      <ul className="space-y-4">
                        {[
                          ...
                          'Letters of Recommendation (for selected programs)',
                          'Relevant work experience (for some professional courses)'
                        ].map((req, i) => (
                          <li key={i} className="flex items-start gap-3">
                            <div className="mt-1 w-5 h-5 rounded-full bg-primary/10 flex items-center justify-center shrink-0">
                              <div className="w-2 h-2 rounded-full bg-primary" />
                  ...
                  <motion.div variants={fadeUp} className="bg-gradient-to-br from-primary/5 to-orange-500/5 rounded-[2rem] p-8 md:p-10 border border-primary/20 relative overflow-hidden">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                      {[
                        ...
                        { level: 'Nursing/Health', score: '7.0+ IELTS' }
                      ].map((req, i) => (
                        <motion.div 
                          key={i} 
                          whileHover={{ y: -5 }}
                ...
                >
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    <motion.div variants={fadeUp} className="bg-white p-8 rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100">
                      ...
                      <p className="text-sm text-muted-foreground mb-4">Students holding a valid Student Visa (Subclass 500) may work while studying.</p>
                      <ul className="space-y-4">
                        {[
                          'Work during course while complying with current visa work limitations.',
                          'Work full-time during recognised course breaks.',
                          'Sectors: Hospitality, Retail, Administration, IT, Tutoring.'
                        ].map((text, i) => (
                          <li key={i} className="flex items-start gap-3">
                    ...
                    <motion.div variants={fadeUp} className="bg-gray-900 p-8 rounded-3xl shadow-xl text-white">
                      ...
                      <p className="text-sm text-gray-300 mb-4">
                        Australia offers eligible graduates opportunities to gain valuable work experience.
                      </p>
                      <ul className="space-y-4">
                        {[
                          'Apply for post-study work pathways to live and work in Australia.',
                          'Develop professional skills & build international experience.',
                          'Enhance career prospects.',
                          'Explore longer-term skilled migration pathways where eligible.'
                        ].map((text, i) => (
                          <li key={i} className="flex items-start gap-3">
              ...
              <div className="lg:col-span-4 space-y-6">
                  ...
                  >
                    ...
                    <div className="space-y-6">
                      <div>
                        <p className="text-sm text-muted-foreground uppercase tracking-wider font-bold mb-3">Tuition Fees (Yearly AUD)</p>
                        <div className="space-y-3">
                          {[
                            { level: 'English Programs', fee: '$300–$450/wk' },
                            { level: 'Diploma Programs', fee: '$12k–$22k' },
                            { level: 'Bachelor\'s Degree', fee: '$20k–$50k' },
                            { level: 'Master\'s Degree', fee: '$22k–$55k' },
                            { level: 'Research (PhD)', fee: '$20k–$50k' }
                          ].map((item, i) => (
                      ...
                      <div>
                        <p className="text-sm text-muted-foreground uppercase tracking-wider font-bold mb-3">Living Cost (Yearly AUD)</p>
                        <div className="space-y-3">
                          {[
                            { item: 'Accommodation', cost: '$10k–$22k' },
                            { item: 'Food', cost: '$4k–$8k' },
                            { item: 'Transport', cost: '$1,500–$3,000' },
                            { item: 'Utilities & Internet', cost: '$2k–$3,500' },
                            { item: 'Personal Expenses', cost: '$2,500–$5k' }
                          ].map((item, i) => (
                            <div key={i} className="flex justify-between items-center bg-gray-50 p-3 rounded-xl border border-gray-100">
                      ...
                      <div className="text-xs text-muted-foreground bg-gray-50 p-3 rounded-xl border border-gray-100">
                        *Students must also budget for Overseas Student Health Cover (OSHC).
                      </div>
                    </div>
                  </motion.div>
                    ...
                    <div className="relative z-10">
                      ...
                      <ul className="space-y-4">
                        {[
                          ...
                          'Early Acceptance Discounts',
                          'Regional Campus Incentives',
                          'Pathway Program Discounts'
                        ].map((sch, i) => (
                      ...
                      <p className="text-xs text-gray-400 mt-4 italic">*Values range from 10% to 100% of tuition fees.</p>
                    </div>
                  </motion.div>
                  ...
                  <div className="sticky top-24 z-10">
                    ...
                    <p className="text-white/90 text-sm mb-6 relative z-10 leading-relaxed font-medium">
                      We are committed to helping students make informed decisions and achieve their international education goals.
                    </p>
                    <ul className="text-sm text-white/90 space-y-2 mb-8 text-left bg-black/20 p-4 rounded-xl relative z-10">
                      <li className="flex items-start gap-2"><CheckCircle className="h-4 w-4 text-amber-400 shrink-0 mt-0.5" /> Course Selection</li>
