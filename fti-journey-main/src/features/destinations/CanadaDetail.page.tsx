        ...
        <section ref={heroRef} className="relative h-[70vh] min-h-[600px] flex items-center justify-center overflow-hidden rounded-b-[3rem] shadow-2xl">
          <motion.div style={{ y, opacity }} className="absolute inset-0 w-full h-full">
            <img
              ...
              alt="Study in Canada - Toronto Skyline"
          ...
          <div className="container relative z-10 mx-auto px-4 text-center mt-16">
            ...
            >
              ...
              <span className="text-white font-medium tracking-wide text-sm uppercase">World-Class Education</span>
            </motion.div>
            ...
            >
              Study in <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-400 to-orange-500">Canada</span>
            </motion.h1>
            ...
            >
              Endless Opportunities. Exceptional standard of living. Globally recognized qualifications.
            </motion.p>
          </div>
          ...
          >
            {[
              { icon: Building, label: 'Quality of Life', value: 'Top Ranked' },
              { icon: Globe, label: 'Work Permit', value: 'PGWP Eligible' },
              { icon: Award, label: 'Multicultural', value: 'Welcoming' }
            ].map((stat, i) => (
              ...
              <div className="lg:col-span-8 space-y-16">
                ...
                >
                  <motion.div variants={fadeUp} className="flex items-center gap-4 mb-6">
                    ...
                    <h2 className="text-3xl md:text-4xl font-black text-foreground tracking-tight">Discover Canada</h2>
                  </motion.div>
                  
                  <motion.p variants={fadeUp} className="text-lg text-muted-foreground leading-relaxed mb-6">
                    Canada is one of the world's most sought-after destinations for international students, offering high-quality education, globally recognized qualifications, and an exceptional standard of living. With a welcoming multicultural society, innovative teaching methods, and strong links between education and industry, Canada provides students with the knowledge and practical skills needed for long-term career success.
                  </motion.p>
                  <motion.p variants={fadeUp} className="text-lg text-muted-foreground leading-relaxed mb-10">
                    Canadian qualifications are respected worldwide, and graduates enjoy excellent employment opportunities both in Canada and internationally.
                  </motion.p>
                  ...
                  <motion.div variants={fadeUp} className="grid grid-cols-1 md:grid-cols-3 gap-4 h-[400px]">
                    <div className="md:col-span-2 h-full rounded-3xl overflow-hidden group relative shadow-lg">
                      <img src="https://images.unsplash.com/photo-1559511260-66a654ae982a?auto=format&fit=crop&w=1200" alt="Vancouver" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" />
                      <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent flex items-end p-6">
                        <span className="text-white font-bold text-xl drop-shadow-md">Beautiful Vancouver</span>
                      </div>
                    </div>
                    <div className="grid grid-rows-2 gap-4 h-full">
                      ...
                      <div className="rounded-3xl overflow-hidden group relative shadow-lg bg-gradient-to-br from-primary to-orange-600 flex items-center justify-center p-6 text-center">
                        <div>
                          <p className="text-4xl font-black text-white mb-2">PGWP</p>
                          <p className="text-white/80 text-sm font-medium">Post-Grad Work Permit</p>
                        </div>
                      </div>
                    </div>
                  </motion.div>
                ...
                >
                  <motion.div variants={fadeUp} className="flex items-center gap-4 mb-8">
                    ...
                    <h2 className="text-3xl font-bold text-foreground">Why Study in Canada?</h2>
                  </motion.div>
                  ...
                  <div className="grid sm:grid-cols-2 gap-4">
                    {[
                      ...
                      'Affordable tuition compared to top destinations',
                      'Safe and multicultural environment',
                      'Strong graduate employability',
                      'Industry-focused learning (Co-op)',
                ...
                >
                  ...
                  <motion.div variants={fadeUp} className="flex items-center gap-4 mb-8 relative z-10">
                    ...
                    <div>
                      <h2 className="text-3xl font-bold text-foreground">Canadian Education System</h2>
                      <p className="text-muted-foreground mt-1 text-sm">Regulated by provincial and territorial governments ensuring high academic standards.</p>
                    </div>
                  </motion.div>
                  ...
                  <div className="grid md:grid-cols-2 gap-10 relative z-10">
                    <div>
                      ...
                      <div className="flex flex-wrap gap-2">
                        {['English Programs (ESL)', 'Certificate & Diploma', 'Advanced Diploma', 'Bachelor\'s Degrees', 'Graduate Certificates', 'Master\'s Degrees', 'Doctoral (PhD) Programs'].map((level, i) => (
                ...
                >
                  <motion.div variants={fadeUp} className="flex items-center gap-4 mb-8">
                    ...
                    <h2 className="text-3xl font-bold text-foreground">Popular Study Programs</h2>
                  </motion.div>
                    ...
                    {[
                      {
                        ...
                        icon: Briefcase,
                        items: ['Business Administration', 'Accounting', 'Finance', 'Marketing', 'HR Management', 'International Business', 'Supply Chain', 'Project Management']
                      },
                      {
                        title: 'Information Technology',
                        icon: Lightbulb,
                        items: ['Computer Science', 'Artificial Intelligence', 'Cyber Security', 'Software Engineering', 'Data Analytics', 'Cloud Computing', 'Web Development']
                      },
                      {
                        title: 'Engineering',
                        icon: Building,
                        items: ['Civil Engineering', 'Mechanical', 'Electrical', 'Chemical', 'Environmental', 'Mechatronics', 'Industrial']
                      },
                      {
                        title: 'Health Sciences',
                        icon: CheckCircle,
                        items: ['Nursing', 'Public Health', 'Healthcare Administration', 'Pharmacy', 'Medical Laboratory', 'Occupational Health']
                      },
                      {
                        title: 'Hospitality & Tourism',
                        icon: MapPin,
                        items: ['Hospitality Management', 'Hotel Management', 'Tourism Management', 'Event Management']
                      },
                      {
                        title: 'Skilled Trades',
                        icon: Wrench,
                        items: ['Automotive Technology', 'Construction Management', 'Electrical Technology', 'Welding', 'Carpentry']
                      },
                      {
                        title: 'Creative Arts',
                        icon: Palette,
                        items: ['Graphic Design', 'Animation', 'Film Production', 'Interior Design', 'Architecture', 'Digital Media']
                      }
                    ].map((category, i) => (
                      <motion.div 
                        key={i}
                ...
                >
                  ...
                  <div className="grid md:grid-cols-2 gap-6 mb-12">
                    <motion.div variants={fadeUp} className="group relative bg-white p-8 rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100 hover:shadow-xl transition-all duration-300">
                      <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-gray-200 to-gray-300 group-hover:from-red-500 group-hover:to-red-400 transition-all duration-500 rounded-t-3xl" />
                    ...
                    <motion.div variants={fadeUp} className="group relative bg-white p-8 rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100 hover:shadow-xl transition-all duration-300">
                      <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-gray-200 to-gray-300 group-hover:from-red-500 group-hover:to-red-400 transition-all duration-500 rounded-t-3xl" />
                      <h3 className="text-2xl font-bold text-foreground mb-6">Graduate & Postgrad</h3>
                      <ul className="space-y-4">
                        {[
                          'Bachelor\'s degree', 
                          'Academic transcripts', 
                          'Resume/CV (where required)', 
                          'Statement of Purpose', 
                          'English language proficiency',
                          'Letters of Recommendation (selected programs)',
                          'Relevant work experience (for some professional programs)'
                        ].map((req, i) => (
                          <li key={i} className="flex items-start gap-3">
                            <div className="mt-1 w-5 h-5 rounded-full bg-primary/10 flex items-center justify-center shrink-0">
                              <div className="w-2 h-2 rounded-full bg-primary" />
                  ...
                  <motion.div variants={fadeUp} className="bg-gradient-to-br from-red-50 to-white rounded-[2rem] p-8 md:p-10 border border-primary/20 relative overflow-hidden">
                    ...
                    <p className="text-muted-foreground mb-6">
                      Accepted tests: IELTS Academic, PTE Academic, TOEFL iBT, Duolingo English Test, CAEL, Cambridge English.
                    </p>
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                      {[
                        { level: 'Diploma', score: '6.0 IELTS' },
                        { level: 'Bachelor\'s Degree', score: '6.0–6.5 IELTS' },
                        { level: 'Master\'s / Grad Cert', score: '6.5–7.0 IELTS' },
                ...
                >
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    <motion.div variants={fadeUp} className="bg-white p-8 rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100">
                      ...
                      <p className="text-sm text-muted-foreground mb-4">Eligible international students with a valid Canadian study permit may work subject to IRCC regulations.</p>
                      <ul className="space-y-4">
                        {[
                          'Work part-time during regular academic sessions.',
                          'Work full-time during scheduled academic breaks if eligible.',
                          'Sectors: Retail, Hospitality, IT, Admin, Research, and On-campus.'
                        ].map((text, i) => (
                          <li key={i} className="flex items-start gap-3">
                    ...
                    <motion.div variants={fadeUp} className="bg-gray-900 p-8 rounded-3xl shadow-xl text-white">
                      <h3 className="text-xl font-bold mb-4 flex items-center gap-2">
                        <Award className="w-5 h-5 text-amber-400" /> Post-Graduation Work Permit (PGWP)
                      </h3>
                      <p className="text-sm text-gray-300 mb-4">
                        Graduates from eligible designated learning institutions (DLIs) may qualify for a PGWP, enabling them to:
                      </p>
                      <ul className="space-y-4">
                        {[
                          'Gain Canadian professional work experience.',
                          'Improve career prospects globally.',
                          'Build eligibility for various permanent residency pathways.',
                          'Enhance long-term employment opportunities.'
                        ].map((text, i) => (
                          <li key={i} className="flex items-start gap-3">
              ...
              <div className="lg:col-span-4 space-y-6">
                  ...
                  >
                    ...
                    <div className="space-y-6">
                      <div>
                        <p className="text-sm text-muted-foreground uppercase tracking-wider font-bold mb-3">Tuition Fees (Yearly CAD)</p>
                        <div className="space-y-3">
                          {[
                            { level: 'ESL Programs', fee: '$250–$450/wk' },
                            { level: 'Diploma Programs', fee: '$14k–$22k' },
                            { level: 'Bachelor\'s Degrees', fee: '$18k–$45k' },
                            { level: 'Grad Certificates', fee: '$16k–$28k' },
                            { level: 'Master\'s Degrees', fee: '$18k–$40k' },
                            { level: 'PhD Programs', fee: '$8k–$25k' }
                          ].map((item, i) => (
                      ...
                      <div>
                        <p className="text-sm text-muted-foreground uppercase tracking-wider font-bold mb-3">Living Cost (Yearly CAD)</p>
                        <div className="space-y-3">
                          {[
                            { item: 'Accommodation', cost: '$8k–$18k' },
                            { item: 'Food', cost: '$3,500–$6,500' },
                            { item: 'Transportation', cost: '$1,000–$2,500' },
                            { item: 'Utilities & Internet', cost: '$1,500–$3,000' },
                  ...
                  >
                    ...
                    <div className="relative z-10">
                      <h3 className="text-2xl font-bold mb-6 flex items-center gap-3">
                        <Award className="h-6 w-6 text-amber-400" /> Scholarships & Aids
                      </h3>
                      <ul className="space-y-4">
                        {[
                  ...
                  <div className="sticky top-24 z-10">
                    ...
                    <p className="text-white/90 text-sm mb-6 relative z-10 leading-relaxed font-medium">
                      We provide comprehensive guidance throughout your Canadian education journey.
                    </p>
                    <ul className="text-sm text-white/90 space-y-2 mb-8 text-left bg-black/20 p-4 rounded-xl relative z-10">
                      <li className="flex items-start gap-2"><CheckCircle className="h-4 w-4 text-amber-400 shrink-0 mt-0.5" /> University & College Selection</li>
                      <li className="flex items-start gap-2"><CheckCircle className="h-4 w-4 text-amber-400 shrink-0 mt-0.5" /> Study Permit Guidance</li>
